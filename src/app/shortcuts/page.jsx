...
function KeyBadge({ children }) {
    return (
        <kbd className="inline-flex items-center justify-center min-w-[32px] h-8 px-2.5 
            bg-white/60 dark:bg-white/10 
            backdrop-blur-sm 
            border border-slate-200/60 dark:border-white/20 
            rounded-lg text-xs font-mono font-semibold 
...
function ShortcutSection({ title, icon: Icon, items, color }) {
    return (
        <div className="mb-6">
            ...
            {/* Light: glassmorphism style | Dark: dashboard card style */}
            ...
            <div className="relative z-10 max-w-2xl mx-auto px-6 py-12">
                ...
                <div className="flex items-center gap-4 mb-8">
                    <button
                        onClick={() => router.back()}
                        className="p-2.5 
                            bg-white/70 dark:bg-[var(--color-card)] 
                            backdrop-blur-xl dark:backdrop-blur-none 
                            border border-white/50 dark:border-0 
                            dark:ring-1 dark:ring-[var(--color-border-ui)] 
                            rounded-xl shadow-sm hover:shadow-md 
                            hover:bg-white/90 dark:hover:bg-purple-500/10 
                            transition-all"
                        aria-label="Go back"
                    >
                ...
                {/* Main Card - Light: glassmorphism | Dark: dashboard card style */}
                <div className="bg-white/70 dark:bg-[var(--color-card)] backdrop-blur-3xl dark:backdrop-blur-none border border-white/50 dark:border-0 dark:ring-1 dark:ring-[var(--color-border-ui)] shadow-2xl shadow-indigo-500/10 dark:shadow-none rounded-3xl p-8">
                    ...
                    {/* Tip Box - Light: gradient bg | Dark: subtle bg */}
